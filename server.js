...
if (!MONGODB_URI) {
  ...
  console.error('Set MONGODB_URI in your Render.com service Environment Variables and redeploy.');
  process.exit(1);
}
...
async function appHandler(req, res) {
  try {
    ...
    if (page === 'staff_notifs' || page === 'student_notifs') {
      const type = user.role === 'staff' ? 'staff' : 'student';
